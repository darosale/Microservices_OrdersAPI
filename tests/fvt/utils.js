...
exports.getOrders = function(itemname, callback) {
    exports.makeRestCall({method: 'GET'}, '/rest/orders', null, function(err, resp, body) {
        if(resp.statusCode === 200) {
            ...
            return callback("Failed to get Orders", null);
        }
    });
}